...
<script>
  // Função para abrir o modal com os dados de um item existente (edição)
  document.querySelectorAll('.faxina-item').forEach(function(item) {
    item.addEventListener('click', function() {
      const modal = new bootstrap.Modal(document.getElementById('modalFaxina'));

      // Preenche os campos do modal com os dados do item clicado
      document.getElementById('inputIdCliente').value = this.dataset.idcliente;
      document.getElementById('inputTipo').value = this.dataset.idtipo;
      document.getElementById('inputData').value = this.dataset.data;
      document.getElementById('inputDuracao').value = this.dataset.duracao;
      document.getElementById('inputPreco').value = this.dataset.preco;
      document.getElementById('inputRua').value = this.dataset.rua;
      document.getElementById('inputBairro').value = this.dataset.bairro;
      document.getElementById('inputNumero').value = this.dataset.numero;
      document.getElementById('inputCidade').value = this.dataset.cidade;
      document.getElementById('inputEstado').value = this.dataset.estado;
      document.getElementById('inputTelefone').value = this.dataset.telefone;
      document.getElementById('inputComplemento').value = this.dataset.complemento;
      document.getElementById('inputObservacao').value = this.dataset.observacao;

      // Muda texto do botão e título do modal para edição
      document.getElementById('botaoAgendar').textContent = 'Salvar';
      document.getElementById('tituloModalFaxina').textContent = 'Editar Faxina';

      modal.show();
    });
  });

  // Função para abrir modal para nova faxina
  function abrirModalNovo() {
    ...
    // Muda texto do botão e título do modal para nova inclusão
    document.getElementById('botaoAgendar').textContent = 'Cadastrar';
    document.getElementById('tituloModalFaxina').textContent = 'Nova Faxina';
