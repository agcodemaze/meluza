...
$cliente = $siteAdmin->getClienteInfoById($id, USER_ID);
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted font-14">Aqui você pode fazer alterações no cadastro do Cliente
                                    </p>
                                        ...
                                        <div class="tab-pane show active" id="tooltips-validation-preview">
                                            <form id="form" name="form" role="form" method="POST" enctype="multipart/form-data">                                       
                                                ...
                                                <div class="position-relative mb-3" id="campo-nome">
                                                  ...
                                                  <input value="<?php echo $cliente["CLI_DCNOME"]; ?>" id="nome" name="nome" autocomplete="new-nome" style="text-transform: uppercase;" type="text" class="form-control" placeholder="" maxlength="50"  oninput="this.value = this.value.replace(/[^\p{L} ]/gu, '')" required/>
                                                </div>
