    ...
    var t = {
            ...
            447: function(t, e, n) {
                        ...
                        function l(l) {
                            return function(s) {
                                return function(l) {
                                    ...
                                    for (; r && (r = 0, l[0] && (o = 0)), o;) try {
                                        if (n = 1, i && (a = 2 & l[0] ? i.O : l[0] ? i.g || ((a = i.O) && a.call(i), 0) : i.next) && !(a = a.call(i, l[1])).done) return a;
                                        switch (i = 0, a && (l = [2 & l[0], a.value]), l[0]) {
                                            ...
                                            case 7:
                                                ...
                                                continue;
                                            default:
                                                if (!(a = o.M, (a = a.length > 0 && a[a.length - 1]) || 6 !== l[0] && 2 !== l[0])) {
                                                    o = 0;
                                                    continue
                                                }
                ...
                var r = n(572),
                    ...
                    d = function() {
                        function t() {
                            this._ = 0 === window.location.protocol.indexOf("http"), this.content = l.l.get("content"), this.location = new s.D(window.location.protocol, window.location.host, this.content.dataset.path || window.location.pathname), this.A = {}, this.search = new c.R, this.P = new o.L, this.N = new u.m, this.version = ""
                        }
                        return t.prototype.G = function() {
                            ...
                            var e = "true" === this.content.dataset.H,
                                n = l.l.create("div");
                            n.innerHTML = r.default;
                            var i = null;
                            if (!this.location.I && !e) {
                                var a = l.l.u(n, "menu"),
                                    o = this.J();
                                a.appendChild(o);
                                var s = function() {
                                    o.scrollHeight <= o.offsetHeight ? (a.classList.add("no-gradient-bottom"), a.classList.add("no-gradient-top")) : (o.scrollTop + o.offsetHeight + 1 >= o.scrollHeight ? a.classList.add("no-gradient-bottom") : a.classList.remove("no-gradient-bottom"), 0 == o.scrollTop ? a.classList.add("no-gradient-top") : a.classList.remove("no-gradient-top"))
                                };
                            ...
                            var c = l.l.u(n, "toolbar"),
                                u = this.F();
                            c.appendChild(u);
                            var d = l.l.u(n, "placeholder");
                            this.placeholder = d, d.appendChild(this.q(document)), m.i.o ? d.appendChild(this.content) : d.appendChild(this.content.content), new h.K(this.placeholder).Y(), document.body.insertBefore(n, document.body.firstChild), this.search.v(), i && this.U(i), this.location.X && !this.location.sandbox && this.N.v()
                            ...
                            var n = l.l.create("ul"),
                                i = this.location.Z;
                            return this.P.getItems(i).forEach((function(e) {
                                var i = e.filename;
                                "index.html" !== i || t.location.filesystem || (i = "./");
                                var a = t.$(e.text, i, e.filename === t.location.filename, e.tt);
                                n.appendChild(a.div)
                            })), e.appendChild(n), e
                            ...
                            if ("string" == typeof e) {
                                ...
                                if (o.href = e, o.title = t, n && (o.className = "active"), this._ && o.addEventListener("click", (function(t) {
                                        window.innerWidth <= 1e3 || (t.preventDefault(), a.et(e))
                                    })), i) {
                                    var s = l.l.create("span");
                                    s.innerText = "NEW", s.className = "new", o.appendChild(s)
                                }
                                var c = l.l.create("span");
                                c.innerText = t, o.appendChild(c), r.appendChild(o)
                            } else {
                                var u = l.l.create("strong");
                                u.innerText = t, r.appendChild(u)
                            }
                            return {
                                div: r
                            }
                            ...
                            var t = this,
                                ...
                                a = this.location.sandbox ? "Sandbox" : "Demo",
                                r = this.nt(a, n + i, this.location.I);
                            return e.appendChild(r.div), this.P.it().forEach((function(a) {
                                var r = "".concat(n).concat(a.Z, "/").concat(i),
                                    o = a.Z === t.location.Z,
                                    l = t.nt(a.text, r, o, a.tt);
                                e.appendChild(l.div)
                            })), e
                        }, t.prototype.nt = function(t, e, n, i) {
                            void 0 === i && (i = !1);
                            var a = l.l.create("div");
                            a.className = "dpw-header-item";
                            var r = document.createElement("a");
                            if (r.href = e, r.innerText = t, n && (r.className = "dpw-header-item-selected"), a.appendChild(r), i) {
                                var o = l.l.create("span");
                                o.innerText = "NEW", o.className = "new-after", r.appendChild(o)
                            }
                            return {
                                div: a,
                                a: r
                            ...
                            return i(this, void 0, void 0, (function() {
                                ...
                                return a(this, (function(a) {
                                    switch (a.label) {
                                        case 0:
                                            return this.A[t] ? [2, this.A[t]] : [4, fetch(t)];
                                        case 1:
                                            return (e = a.k()).ok ? [4, e.text()] : [2, null];
                                        case 2:
                                            return -1 === (n = a.k()).indexOf("<!DOCTYPE html>") ? [2, null] : (i = new f(n), this.rt(i.ot), this.A[t] = i, [2, i])
                                    }
                                }))
                            }))
                        }, t.prototype.et = function(t, e) {
                            return i(this, void 0, void 0, (function() {
                                var n, i, r, o, s, c, u, m, d, f, v;
                                return a(this, (function(a) {
                                    switch (a.label) {
                                        case 0:
                                            return n = window.location.href, (i = this.A[t]) ? [3, 2] : [4, this.B(t)];
                                        case 1:
                                            i = a.k(), a.label = 2;
                                        case 2:
                                            return i ? (r = i.ot, o = r.querySelector("#content").content, this.rt(r), o.querySelectorAll("script").forEach((function(t) {
                                                var e = t.parentNode,
                                                    n = document.createElement("script");
                                                n.innerHTML = "(function() {".concat(t.innerHTML, "})();"), e.replaceChild(n, t)
                                            })), this.placeholder.innerHTML = "", this.placeholder.appendChild(this.q(r)), this.placeholder.appendChild(o), (s = r.querySelector("script[src*='jquery']")) && (c = s.getAttribute("src")) && (document.querySelector('script[src="'.concat(c, '"]')) || ((u = document.createElement("script")).setAttribute("src", c), document.head.appendChild(u))), new h.K(this.placeholder).Y(), m = r.querySelector("title"), document.title = m.innerText, e || window.history.pushState({}, "", t), this.search.v(), d = l.l.u(document.body, "dp-menu"), (f = d.querySelector("a.active")) && f.classList.remove("active"), (v = d.querySelector('a[href="'.concat(t, '"]'))) && (v.classList.add("active"), this.U(v)), this.lt({
                                                referrer: n
                                            }), [2]) : [2]
                                    }
                                }))
            ...
            11: function(t, e) {
                ...
                var n = function() {
                    ...
                    return Object.defineProperty(t.prototype, "I", {
                        ...
                        this.filename = this.ht(this.pathname), this.Z = this.dt(this.pathname), this.sandbox = this.ft(this.pathname), this.X = this.vt(this.host), this.filesystem = this.xt(this.protocol)
            ...
            463: function(t, e, n) {
                ...
                var i = n(143),
                    a = function() {
                        ...
                        return t.prototype.v = function() {
                            var t = this,
                                e = this.gt = i.l.get("search-box-input");
                            e.addEventListener("keyup", (function(n) {
                                "Escape" !== n.key && "Esc" !== n.key || (e.value = ""), t.bt(e.value)
                            })), i.l.get("search-box-clear").addEventListener("click", (function(n) {
                                t.yt(), e.focus()
                            }))
                            ...
                            var e = !t || "" === t.trim();
                            e ? this.Tt() : this.Et(), i.l.query(".menu li").forEach((function(n) {
                                var i = n.getElementsByTagName("a")[0],
                                    a = i && -1 !== i.innerText.toLowerCase().indexOf(t.toLowerCase()),
                                    r = e || a;
                ...
                var i = n(143),
                    ...
                    o = function() {
                        ...
                        return t.prototype.Y = function() {
                            ...
                            var t, e = this.Mt(),
                                n = r.i.o ? e.innerText : e.innerHTML,
                                o = n;
                            ...
                            r.i.o ? ((t = i.l.create("div")).innerHTML = "<pre>" + a.jt.zt(o) + "</pre>", this.placeholder.appendChild(t)) : ((t = i.l.create("pre")).innerText = a.jt.zt(o), this.placeholder.appendChild(t))
            ...
            4: function(t, e) {
                ...
                var n = [{
                        ...
                        children: [{
                            ...
                            text: "Exact Event Duration",
                            filename: "eventexactduration.html",
                            tt: !0
                        }, {
                            text: "Localization"
                        }, {
                        ...
                        children: [{
                            ...
                            text: "Time Header Customization",
                            filename: "timeheadercustomization.html",
                            tt: !0
                        }, {
                            text: "Scale: Minutes",
                            filename: "scaleminutes.html"
                        }, {
                            text: "Scale: Hours",
